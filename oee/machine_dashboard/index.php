...
tempData.oeeDash.oeeCirclePerc('oeePerc',90,'#E29C21');
          ...
          <div class="panel-body">  
            <div class="row">
              <div class="col-md-12 col-xs-12 text-center">
                <input type="text" class="knob" id="oeePerc" data-skin="tron" data-thickness="0.2" data-width="100" data-height="100" readonly>
              </div>
