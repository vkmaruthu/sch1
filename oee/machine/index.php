...
tempData.oeemachine=
{
  generateTile:function(id,val,fgColor) {  
    ...
    $('#viewTile').html('');
      ...
      for(var i=0;i<=8;i++){
         var tile='<div class="col-md-4 col-xs-12" style="margin-bottom: 1%;"> <div class="col-md-12 col-xs-12 boxPlants"> <div class="col-md-8 col-xs-8"> <h3 style="font-size:21px;margin-top:4%;margin-bottom: 10%;font-weight:bold;"> Machine '+i+' </h3> <h4 style="padding:3%;">Availability <span class="pull-right boxPlantsInner" style="background-color:orange;">52</span></h4> <h4 style="padding:3%;">Performance <span class="pull-right boxPlantsInner" style="background-color:orange;">52</span></h4> <h4 style="padding:3%;">Quality <span class="pull-right boxPlantsInner" style="background-color:orange;">52</span></h4> </div><div class="col-md-4 col-xs-4"> <div class="widget-user-image" style="margin-top:5%;"> <img class="img-thumbnail" src="../common/img/machine/default.png" alt="Machine"></img> </div><h2 style="margin:0px;"> <p class="boxPlantOee">'+(i+20)+'% </p><p class="text-center" style="font-size:30px;margin-top: -12%;">OEE</p></h2> </div><div class="col-md-5 col-xs-5"> <img src="../common/img/online.png" class="img-responsive"/> </div><div class="col-md-6 col-xs-6 pull-right" style="margin-top: -3%;margin-bottom: 3%;"> <h2 class="btn btn-primary btn-xs btn-block" onclick="tempData.oeemachine.visitDashboard();"> <span style="font-size: 15px;">View Details </span> <i class="fa fa-arrow-circle-right" style="font-size: 18px;float: right; margin-top:2%;"></i> </h2> </div></div></div>';
