...
.login-block{
    ...
    background: linear-gradient(to bottom, #85b8ff, #003785);
    float: left;
    width: 100%;
    padding: 50px 0;
    height: 800px;
...
.banner-text p{color:#ffffff;    text-shadow: 3px 1px 2px black;
}
...
<section class="login-block">
    <div class="container">
  <div class="row">
    <div class="col-md-4 col-xs-11 login-sec">
...
<!--     <label class="form-check-label">
    ...
    <button type="submit" class="btn btn-login pull-right">Login <i class="fa fa-arrow-circle-right"></i></button>
  </div>
